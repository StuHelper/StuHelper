...
export const DEFAULT_GROUP_GUARD_MESSAGES: StuhelperGroupGuardMessageConfig = Object.freeze({
  ...
  admissionNextStepLinked: 'QQ 已绑定，但还没有有效学生认证凭据；请前往 StuHelper 独立学生认证页面选择当前可用的认证方式。',
  admissionNextStepMaterialSubmitted: '独立学生认证的人工材料正在审核；审核通过并形成有效凭据后，机器人会自动解除禁言。',
