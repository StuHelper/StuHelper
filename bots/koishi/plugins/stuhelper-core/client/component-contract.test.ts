...
test('SettingsView manages group-guard keyword rules through dedicated WebUI API', () => {
  ...
  assert.match(source, /keywordRulesApi\.delete\(rule\.id\)/)
...
test('SettingsView manages group guard AI review through WebUI runtime settings without plaintext key echo', () => {
  ...
  assert.match(source, /function applyGroupGuardAIApiKeyMetadata\(data: unknown\)/)
  ...
  assert.match(source, /function buildGroupGuardAISettingsPayload\(\): GroupGuardAISettingsUpdate/)
  assert.match(source, /payload\.clearApiKey = true/)
  assert.match(source, /payload\.newApiKey = newApiKey/)
  assert.match(source, /await groupGuardAISettingsApi\.update\(buildGroupGuardAISettingsPayload\(\)\)/)
...
test('SettingsView manages group guard messages through WebUI runtime settings', () => {
  ...
  assert.match(source, /function buildGroupGuardMessageSettingsPayload\(\): GroupGuardMessageSettings/)
  assert.match(source, /await groupGuardMessageSettingsApi\.update\(buildGroupGuardMessageSettingsPayload\(\)\)/)
