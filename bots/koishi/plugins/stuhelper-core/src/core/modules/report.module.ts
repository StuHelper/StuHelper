    ...
    this.registerCommand({
      ...
      .action(async ({ session, options }) => {
        ...
        if (hasChanges) {
          ...
          await this.ctx.stuhelperGroupCenter.settings.update({ report: currentReport })
  ...
  private async handleViolation(
    ...
    try {
      ...
      try {
        ...
        await this.ctx.stuhelperGroupCenter.pushMessage(bot, message, 'warning')
      } catch (e) {
      ...
      try {
        ...
        await this.ctx.stuhelperGroupCenter.pushMessage(bot, errorMessage, 'warning')
      } catch (err) {
