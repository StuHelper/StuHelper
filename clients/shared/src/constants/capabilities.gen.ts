...
export const ROLE_CAPABILITIES = {
  "super_admin": [ADMIN_DASHBOARD_VIEW, ADMIN_REVIEWS_MANAGE, ADMIN_REVIEWS_EDIT_CONTENT, ADMIN_REPORTS_MANAGE, ADMIN_TEACHERS_MANAGE, ADMIN_SENSITIVE_WORDS_MANAGE, ADMIN_LOGS_VIEW, USER_IDENTITY_READ, USER_IDENTITY_REVIEW, USER_STUDENT_READ, USER_STUDENT_REVIEW, USER_SCHOOL_READ, USER_SCHOOL_UPDATE, USER_SYSTEM_READ, USER_SYSTEM_UPDATE, IAM_GRANTS_MANAGE, ADMISSION_POLICY_READ, ADMISSION_POLICY_UPDATE, ADMISSION_FRESHMAN_READ, ADMISSION_FRESHMAN_REVIEW, ADMISSION_SESSION_READ, ADMISSION_SESSION_MANAGE, MEMBER_BLACKLIST_READ, MEMBER_BLACKLIST_MANAGE, OPEN_PLATFORM_READ, OPEN_PLATFORM_MANAGE],
  "school_admin": [ADMIN_REVIEWS_MANAGE, ADMIN_REVIEWS_EDIT_CONTENT, ADMIN_REPORTS_MANAGE, USER_STUDENT_READ, USER_STUDENT_REVIEW, USER_SCHOOL_READ, USER_SCHOOL_UPDATE],
