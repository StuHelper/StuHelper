<template>
  <div>
    <div class="mb-4 flex items-center justify-between">
      <h2 class="text-lg font-semibold text-gray-900">实名认证审核</h2>
    </div>
    ...
    <el-table v-loading="loading" :data="list" border stripe>
      ...
      <el-table-column prop="rejectionReason" label="拒绝原因" min-width="160" show-overflow-tooltip />
...
const VERIFY_METHOD_MAP: Record<string, string> = {
  academic_db_match: '学籍匹配',
  tencent_cloud: '腾讯云',
  manual: '人工审核',
}
