...
export default {
    ...
    openPlatformConsent: {
        ...
        invalidToken:
            "The authorization request is expired or missing a token. Return to the account center or start again from the requesting app.",
    ...
    openPlatformProfileCompletion: {
        ...
        invalidToken:
            "The profile completion request is expired or missing a token. Return to the account center or start again from the requesting app.",
        ...
        refresh: "Check again",
        noMissingFields:
            "Your StuHelper account profile now satisfies this authorization request",
        expiresAt: "Valid until {time}",
    },
    meta: {
        description:
            "StuHelper Course Review Community - Authentic course reviews and teaching feedback to help students make informed choices",
    ...
    bootstrap: {
        ...
        contactSupport:
            "If the issue persists, contact the maintainer with the console error details.",
    },
    loading: {
        label: "Loading",
    },
