...
export default {
  ...
  notFound: {
    ...
    goBack: 'Go Back',
    joinAdmission: {
      title: 'Admission Link Required',
      description: 'This join domain only opens admission verification links generated by the group bot or an administrator. Return to the QQ group and request a fresh verification link.',
      backHome: 'Go to StuHelper',
      goBack: 'Go Back'
    }
  },
  loadError: {
