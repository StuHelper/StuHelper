    ...
    <section class="mx-auto max-w-[960px] p-6 animate-fade-in max-sm:p-4">
        ...
        >
            <div class="min-w-0">
                ...
                <p
                    class="m-0 mt-2 max-w-[720px] text-sm leading-relaxed text-text-secondary"
                >
        ...
        <section class="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
                <div class="flex items-start gap-4">
                    <span
                        class="grid size-12 shrink-0 place-items-center rounded-lg bg-primary-alpha text-primary"
                    >
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="m-0 mt-1 text-sm text-text-secondary">
                            {{
                                user?.email ||
                                t("user.accountSecurity.emailMissing")
                            }}
                        </p>
                    </div>
                </div>
                ...
                <p
                    class="m-0 mt-5 rounded-md border border-border bg-bg-base p-3 text-sm leading-relaxed text-text-secondary"
                >
                    {{ t("user.accountSecurity.accountSummary") }}
                </p>
            </section>
            ...
            >
                <header class="flex items-start gap-3">
                    <span
                        class="grid size-10 shrink-0 place-items-center rounded-lg bg-success/10 text-success"
                    >
                ...
                <div
                    class="mt-4 rounded-md border border-success/20 bg-success/10 p-3 text-sm font-medium text-success"
                >
                ...
                >
                    ...
                    {{
                        loggingOut
                            ? t("user.accountSecurity.session.loggingOut")
                            : t("user.accountSecurity.session.logout")
                    }}
                </button>
            </section>
        </section>
        ...
        >
            ...
            >
                <AccountAction
                    ...
                    :description="
                        t('user.accountSecurity.authorizedApps.description')
                    "
                    :action="t('user.identityHome.open')"
                />
            </router-link>
        ...
        return () =>
            h("div", { class: "flex items-start gap-4" }, [
                h(
                    "span",
                    {
                        class: "grid size-11 shrink-0 place-items-center rounded-lg bg-primary-alpha text-primary",
                    },
...
const displayName = computed(() => user.value?.displayName || t("nav.user"));
