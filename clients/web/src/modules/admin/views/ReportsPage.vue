        ...
        <div class="flex items-center justify-between">
          <div v-if="report.status === 'pending'" class="flex items-center gap-2">
            ...
            <button
              ...
              @click="handleProcess(report.id, 'hide')"
            >
...
const handleProcess = async (id: string, action: 'reject' | 'hide') => {
  try {
    await api.admin.processReport(id, { action })
