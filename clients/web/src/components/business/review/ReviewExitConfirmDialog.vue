<template>
    <Transition name="overlay">
        <div
            v-if="visible"
            class="fixed inset-0 bg-black/30 z-[var(--z-modal)] flex items-center justify-center p-4"
            @click.self="emit('close')"
        >
            <div
                class="bg-bg-card rounded-xl shadow-2xl w-full max-w-[340px] p-6 flex flex-col items-center gap-4 animate-modal-in"
            >
                <div
                    class="w-11 h-11 rounded-full bg-warning/10 flex items-center justify-center"
                >
                    <svg
