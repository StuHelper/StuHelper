...
const publishedCount = useCountUp(() => stats.value.publishedReviews)
const hiddenCount = useCountUp(() => stats.value.hiddenReviews)
const deletedCount = useCountUp(() => stats.value.deletedReviews)
const pendingCount = useCountUp(() => stats.value.pendingReports)
const totalReportsCount = useCountUp(() => stats.value.totalReports)
const todayCount = useCountUp(() => stats.value.todayReviews)
const weekCount = useCountUp(() => stats.value.weekReviews)
...
const statCards = computed(() => [
  {
    ...
    displayValue: totalCount.current.value,
    highlight: false
  },
  {
    key: 'published',
    ...
    displayValue: publishedCount.current.value,
    highlight: false
  },
  {
    key: 'hidden',
    ...
    displayValue: hiddenCount.current.value,
    highlight: false
  },
  {
    key: 'deleted',
    ...
    displayValue: deletedCount.current.value,
    highlight: false
  },
  {
    key: 'pending',
    ...
    displayValue: pendingCount.current.value,
  ...
  },
  {
    ...
    displayValue: totalReportsCount.current.value,
    highlight: false
  },
  {
    key: 'today',
    ...
    displayValue: todayCount.current.value,
    highlight: false
  },
  {
    key: 'week',
    ...
    displayValue: weekCount.current.value,
    highlight: false
  }
])
