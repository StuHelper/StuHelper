...
require_nonempty STUHELPER_INITIAL_SUPER_ADMINS "${STUHELPER_INITIAL_SUPER_ADMINS:-}"
...
reject_placeholder STUHELPER_INITIAL_SUPER_ADMINS "${STUHELPER_INITIAL_SUPER_ADMINS:-}" "REPLACE_WITH_INITIAL_SUPER_ADMIN_USERNAMES"
...
log "ensuring the PostgreSQL authorization control plane has its initial super administrators"
"${SCRIPT_DIR}/authorization-bootstrap-super-admin.sh"
