...
ensure_prod_default "CASDOOR_PUBLIC_AUTH_BASE_URL" "${CASDOOR_PUBLIC_AUTH_BASE_URL:-}" "https://id.stuhelper.com" "REPLACE_WITH_CASDOOR_PUBLIC_AUTH_BASE_URL" "http://localhost:8085"
ensure_prod_default "CASDOOR_REDIRECT_URI" "${CASDOOR_REDIRECT_URI:-}" "https://id.stuhelper.com/api/v1/auth/callback" "REPLACE_WITH_CASDOOR_REDIRECT_URI" "http://localhost:8080/api/v1/auth/callback"
...
ensure_prod_default "CASDOOR_ADMIN_REDIRECT_URI" "${CASDOOR_ADMIN_REDIRECT_URI:-}" "https://id.stuhelper.com/api/v1/auth/callback" "REPLACE_WITH_CASDOOR_ADMIN_REDIRECT_URI" "http://localhost:8080/api/v1/auth/callback"
ensure_value "CASDOOR_UNIAPP_CLIENT_ID" "${CASDOOR_UNIAPP_CLIENT_ID:-}" "stuhelper-uniapp"
ensure_prod_default "CASDOOR_UNIAPP_REDIRECT_URI" "${CASDOOR_UNIAPP_REDIRECT_URI:-}" "https://id.stuhelper.com/api/v1/auth/callback" "REPLACE_WITH_CASDOOR_UNIAPP_REDIRECT_URI" "http://localhost:8080/api/v1/auth/callback"
...
ensure_value "PUBLIC_INGRESS_CASDOOR_UPSTREAM_PREFLIGHT_ENABLED" "${PUBLIC_INGRESS_CASDOOR_UPSTREAM_PREFLIGHT_ENABLED:-}" "false"
...
ensure_value "IDENTITY_PUBLIC_SMOKE_ENABLED" "${IDENTITY_PUBLIC_SMOKE_ENABLED:-}" "true"
...
ensure_prod_default "WEB_VITE_SSO_URL" "${WEB_VITE_SSO_URL:-}" "https://id.stuhelper.com" "REPLACE_WITH_WEB_VITE_SSO_URL" "http://localhost:8085" "http://localhost"
