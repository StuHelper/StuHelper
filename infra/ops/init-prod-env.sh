...
ensure_prod_default "CORS_ORIGINS" "${CORS_ORIGINS:-}" "https://stuhelper.com,https://join.stuhelper.com,https://sso.stuhelper.com" "https://stuhelper.com,https://id.stuhelper.com,https://join.stuhelper.com,https://sso.stuhelper.com" "https://stuhelper.com,https://id.stuhelper.com,https://join.stuhelper.com" "https://stuhelper.com" "https://stuhelper.com,https://id.stuhelper.com" "REPLACE_WITH_PRODUCTION_CORS_ORIGINS" "http://localhost:3000,http://localhost:3001" "http://localhost:3000,http://127.0.0.1:3000,http://localhost:3001,http://127.0.0.1:3001"
...
ensure_prod_default "CASDOOR_PUBLIC_AUTH_BASE_URL" "${CASDOOR_PUBLIC_AUTH_BASE_URL:-}" "https://sso.stuhelper.com" "https://id.stuhelper.com" "REPLACE_WITH_CASDOOR_PUBLIC_AUTH_BASE_URL" "http://localhost:8085"
ensure_prod_default "CASDOOR_REDIRECT_URI" "${CASDOOR_REDIRECT_URI:-}" "https://stuhelper.com/api/v1/auth/callback" "https://id.stuhelper.com/api/v1/auth/callback" "REPLACE_WITH_CASDOOR_REDIRECT_URI" "http://localhost:8080/api/v1/auth/callback"
...
ensure_prod_default "CASDOOR_ADMIN_REDIRECT_URI" "${CASDOOR_ADMIN_REDIRECT_URI:-}" "https://stuhelper.com/api/v1/auth/callback" "https://id.stuhelper.com/api/v1/auth/callback" "REPLACE_WITH_CASDOOR_ADMIN_REDIRECT_URI" "http://localhost:8080/api/v1/auth/callback"
ensure_value "CASDOOR_UNIAPP_CLIENT_ID" "${CASDOOR_UNIAPP_CLIENT_ID:-}" "stuhelper-uniapp"
ensure_prod_default "CASDOOR_UNIAPP_REDIRECT_URI" "${CASDOOR_UNIAPP_REDIRECT_URI:-}" "https://stuhelper.com/api/v1/auth/callback" "https://id.stuhelper.com/api/v1/auth/callback" "REPLACE_WITH_CASDOOR_UNIAPP_REDIRECT_URI" "http://localhost:8080/api/v1/auth/callback"
...
ensure_prod_default "IDENTITY_SERVER_ENABLED" "${IDENTITY_SERVER_ENABLED:-}" "false" "true"
...
ensure_value "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_TIMEOUT" "${PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_TIMEOUT:-}" "10"
ensure_value "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_FILE" "${PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_FILE:-}" "infra/generated/public-identity-ingress-diagnostic.json"
ensure_value "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_STRICT" "${PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_STRICT:-}" "false"
ensure_value "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_PUBLIC_DNS_ENABLED" "${PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_PUBLIC_DNS_ENABLED:-}" "true"
ensure_prod_default "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_USE_ENV_TARGETS" "${PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_USE_ENV_TARGETS:-}" "false" "true"
ensure_prod_default "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_CASDOOR_UPSTREAM_ENABLED" "${PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_CASDOOR_UPSTREAM_ENABLED:-}" "false" "true"
ensure_value "SSO_PUBLIC_SMOKE_ENABLED" "${SSO_PUBLIC_SMOKE_ENABLED:-}" "true"
ensure_prod_default "SSO_PUBLIC_BASE_URL" "${SSO_PUBLIC_BASE_URL:-}" "https://sso.stuhelper.com" "https://id.stuhelper.com" "http://localhost:8085"
ensure_prod_default "SSO_PUBLIC_SMOKE_EXPECTED_ISSUER" "${SSO_PUBLIC_SMOKE_EXPECTED_ISSUER:-}" "https://sso.stuhelper.com" "https://id.stuhelper.com" "http://localhost:8085"
...
ensure_prod_default "SSO_PUBLIC_SMOKE_REDIRECT_URI" "${SSO_PUBLIC_SMOKE_REDIRECT_URI:-}" "https://stuhelper.com/api/v1/auth/callback" "https://id.stuhelper.com/api/v1/auth/callback" "http://localhost:8080/api/v1/auth/callback"
...
ensure_prod_default "IDENTITY_PUBLIC_SMOKE_ENABLED" "${IDENTITY_PUBLIC_SMOKE_ENABLED:-}" "false" "true"
ensure_value "IDENTITY_PUBLIC_SMOKE_BOOTSTRAP_ENABLED" "${IDENTITY_PUBLIC_SMOKE_BOOTSTRAP_ENABLED:-}" "false"
ensure_value "IDENTITY_PUBLIC_SMOKE_BOOTSTRAP_MODE" "${IDENTITY_PUBLIC_SMOKE_BOOTSTRAP_MODE:-}" "container"
ensure_value "IDENTITY_PUBLIC_SMOKE_OWNER_USER_ID" "${IDENTITY_PUBLIC_SMOKE_OWNER_USER_ID:-}" ""
ensure_value "IDENTITY_PUBLIC_SMOKE_REVIEWER_USER_ID" "${IDENTITY_PUBLIC_SMOKE_REVIEWER_USER_ID:-}" ""
ensure_prod_default "IDENTITY_PUBLIC_SMOKE_HOMEPAGE_URL" "${IDENTITY_PUBLIC_SMOKE_HOMEPAGE_URL:-}" "https://stuhelper.com" "http://localhost:3000"
ensure_prod_default "IDENTITY_PUBLIC_SMOKE_PRIVACY_POLICY_URL" "${IDENTITY_PUBLIC_SMOKE_PRIVACY_POLICY_URL:-}" "https://stuhelper.com/privacy" "http://localhost:3000/privacy"
ensure_prod_default "IDENTITY_PUBLIC_SMOKE_ALLOW_LOCAL_TARGETS" "${IDENTITY_PUBLIC_SMOKE_ALLOW_LOCAL_TARGETS:-}" "false" "true"
ensure_prod_default "IDENTITY_PUBLIC_SMOKE_CASDOOR_UPSTREAM_ENABLED" "${IDENTITY_PUBLIC_SMOKE_CASDOOR_UPSTREAM_ENABLED:-}" "false" "true"
...
ensure_prod_default "ADMISSION_PUBLIC_SMOKE_DISABLED_ID_URL" "${ADMISSION_PUBLIC_SMOKE_DISABLED_ID_URL:-}" "https://id.stuhelper.com" "http://localhost:3000"
ensure_value "ADMISSION_PUBLIC_SMOKE_PROBE_TOKEN" "${ADMISSION_PUBLIC_SMOKE_PROBE_TOKEN:-}" "__stuhelper_public_smoke__"
ensure_value "ADMISSION_PUBLIC_SMOKE_PROBE_QQ" "${ADMISSION_PUBLIC_SMOKE_PROBE_QQ:-}" "10000"
...
ensure_prod_default "PUBLIC_WEB_AUTH_BROWSER_SMOKE_DISABLED_ID_URL" "${PUBLIC_WEB_AUTH_BROWSER_SMOKE_DISABLED_ID_URL:-}" "https://id.stuhelper.com" "http://localhost:3000"
...
ensure_value "PUBLIC_WEB_AUTH_BROWSER_SMOKE_PROBE_QQ" "${PUBLIC_WEB_AUTH_BROWSER_SMOKE_PROBE_QQ:-}" "10000"
...
ensure_prod_default "WEB_VITE_SSO_URL" "${WEB_VITE_SSO_URL:-}" "https://sso.stuhelper.com" "https://id.stuhelper.com" "REPLACE_WITH_WEB_VITE_SSO_URL" "http://localhost:8085" "http://localhost"
ensure_prod_default "WEB_VITE_IDENTITY_URL" "${WEB_VITE_IDENTITY_URL:-}" "" "https://id.stuhelper.com" "REPLACE_WITH_WEB_VITE_IDENTITY_URL" "http://localhost:3000"
