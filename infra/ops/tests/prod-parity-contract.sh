...
assert_contains "${PARITY_LOCAL_INGRESS}" 'location = /favicon\.ico'
assert_contains "${PARITY_LOCAL_INGRESS}" 'location = /site\.webmanifest'
...
assert_contains "${PARITY_LOCAL_INGRESS_NGINX}" 'location = /favicon\.ico'
assert_contains "${PARITY_LOCAL_INGRESS_NGINX}" 'location = /site\.webmanifest'
...
assert_contains "${IDENTITY_PUBLIC_SMOKE}" 'Identity favicon 留在 id 入口'
assert_contains "${IDENTITY_PUBLIC_SMOKE}" 'Identity web manifest 留在 id 入口'
