...
assert_contains "${PARITY_UP}" 'STUDENT_VERIFICATION_PUBLIC_BASE_URL.*https://stuhelper\.com'
...
assert_contains "${PARITY_LOCAL_INGRESS}" 'location \^~ /student-verification/manual-camera/'
...
assert_contains "${PARITY_LOCAL_INGRESS}" 'require_cmd pgrep'
assert_contains "${PARITY_LOCAL_INGRESS}" 'pgrep -x nginx'
assert_contains "${PARITY_LOCAL_INGRESS}" 'nginx -s reload'
assert_contains "${PARITY_LOCAL_INGRESS}" 'run_root nginx$'
...
assert_contains "${PARITY_LOCAL_INGRESS_NGINX}" 'location \^~ /student-verification/manual-camera/'
...
assert_contains "${PARITY_SMOKE_DATA}" 'academic\.student_roster_snapshots'
assert_contains "${PARITY_SMOKE_DATA}" 'academic\.student_roster_records'
assert_contains "${PARITY_SMOKE_DATA}" 'academic\.student_roster_active'
assert_contains "${PARITY_SMOKE_DATA}" 'student_email_outbound_otp'
assert_not_contains "${PARITY_SMOKE_DATA}" 'INSERT INTO academic\.buaa_students'
...
assert_contains "${PARITY_SMOKE_DATA}" 'studentVerificationProfileCount'
assert_contains "${PARITY_SMOKE_DATA}" 'studentVerificationEmailMethodCount'
assert_contains "${PARITY_SMOKE_DATA}" 'studentRosterSnapshotCount'
assert_contains "${PARITY_SMOKE_DATA}" 'studentRosterRecordCount'
assert_contains "${PARITY_SMOKE_DATA}" 'studentRosterActiveCount'
...
assert_contains "${PARITY_BROWSER_SMOKE_NODE}" 'identity-retired-identity-verification'
...
assert_contains "${PARITY_BROWSER_SMOKE_NODE}" 'identity-retired-academic-info'
...
assert_contains "${PARITY_BROWSER_SMOKE_NODE}" 'admission-manual-camera-permission'
assert_contains "${PARITY_BROWSER_SMOKE_NODE}" 'admission-retired-sse-route'
assert_contains "${PARITY_BROWSER_SMOKE_NODE}" 'runRetiredAdmissionSSERouteFlow'
...
assert_contains "${PARITY_BROWSER_SMOKE_NODE}" 'web-retired-identity-verification'
...
assert_contains "${PARITY_BROWSER_SMOKE_NODE}" 'web-retired-academic-info'
...
assert_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'browser completes BUAA student email OTP verification'
...
assert_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'data-admission-open-student-verification'
assert_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'data-verification-school-option'
assert_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'data-verification-method="student_email_outbound_otp"'
assert_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'data-verification-student-id'
assert_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'data-verification-name'
assert_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'data-verification-consent'
assert_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'data-verification-submit'
assert_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'data-verification-complete'
assert_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'student-verification:email-otp:challenge:'
assert_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'student-verification-email-otp:v1:'
assert_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'createHmac'
assert_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'HMAC_SECRET'
assert_not_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'admission:email_otp:'
assert_not_contains "${ADMISSION_PROD_SIM_E2E_NODE}" '老生认证'
assert_not_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'data-academic-'
assert_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'credentialKind'
assert_contains "${ADMISSION_PROD_SIM_E2E_NODE}" 'student_email_outbound_otp'
