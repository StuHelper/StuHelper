...
assert_contains "${PARITY_UP}" 'WEB_VITE_SSO_URL.*http://id\.stuhelper\.com'
assert_contains "${PARITY_UP}" 'WEB_VITE_IDENTITY_URL.*http://id\.stuhelper\.com'
assert_contains "${PARITY_UP}" 'WEB_VITE_WEB_URL.*http://stuhelper\.com'
...
assert_contains "${PARITY_UP}" 'CASDOOR_PUBLIC_AUTH_BASE_URL.*http://id\.stuhelper\.com'
assert_contains "${PARITY_UP}" 'CASDOOR_INTERNAL_ADDRESS.*host\.docker\.internal:80'
assert_contains "${PARITY_UP}" 'CASDOOR_REDIRECT_URI.*http://id\.stuhelper\.com/api/v1/auth/callback'
...
assert_contains "${PARITY_BROWSER_SMOKE_NODE}" 'runIdentityHomeAuthenticatedFlow'
