...
assert_contains "${PARITY_UP}" 'IDENTITY_SERVER_ENABLED.*false'
assert_contains "${PARITY_UP}" 'IDENTITY_ISSUER.*""'
assert_contains "${PARITY_UP}" 'WEB_VITE_SSO_URL.*https://sso\.stuhelper\.com'
assert_not_contains "${PARITY_UP}" 'WEB_VITE_IDENTITY_URL.*https://id\.stuhelper\.com'
...
assert_contains "${PARITY_LOCAL_INGRESS}" 'stuhelper\.com www\.stuhelper\.com id\.stuhelper\.com join\.stuhelper\.com sso\.stuhelper\.com'
...
assert_contains "${PARITY_LOCAL_INGRESS}" 'subjectAltName=DNS:stuhelper\.com,DNS:www\.stuhelper\.com,DNS:id\.stuhelper\.com,DNS:join\.stuhelper\.com,DNS:sso\.stuhelper\.com'
...
assert_contains "${ADMISSION_PUBLIC_SMOKE}" 'Identity host verify token returns 404'
