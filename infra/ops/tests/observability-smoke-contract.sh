...
assert_contains "${SMOKE_SCRIPT}" 'up\{job="node-exporter"\}'
assert_contains "${SMOKE_SCRIPT}" 'pg_up\{job="postgres-exporter"\}'
assert_contains "${SMOKE_SCRIPT}" 'redis_up\{job="redis-exporter"\}'
