...
assert_contains "${DEV_UP}" 'DEV_OBJECT_STORAGE_EXTERNAL_PORT_SELECTED="\$\(pick_available_or_current_container_port "\$\{DEV_OBJECT_STORAGE_EXTERNAL_PORT:-9000\}" 30 "\$\{STACK_NAME:-stuhelper-dev\}-object-storage"'
assert_contains "${DEV_UP}" 'LOCAL_OBJECT_STORAGE_TLS_EXTERNAL_PORT_SELECTED="\$\(pick_available_or_current_container_port "\$\{LOCAL_OBJECT_STORAGE_TLS_EXTERNAL_PORT:-9001\}" 30 "\$\{STACK_NAME:-stuhelper-dev\}-object-storage"'
...
assert_contains "${DEV_UP}" 'upsert_env_file "\$\{ENV_FILE\}" "DEV_OBJECT_STORAGE_EXTERNAL_PORT" "\$\{DEV_OBJECT_STORAGE_EXTERNAL_PORT_SELECTED\}"'
assert_contains "${DEV_UP}" 'upsert_env_file "\$\{ENV_FILE\}" "LOCAL_OBJECT_STORAGE_TLS_EXTERNAL_PORT" "\$\{LOCAL_OBJECT_STORAGE_TLS_EXTERNAL_PORT_SELECTED\}"'
...
assert_contains "${DEV_UP}" 'upsert_env_file "\$\{ENV_FILE\}" "ADMISSION_PUBLIC_BASE_URL" "http://join\.localhost:\$\{web_port\}"'
...
assert_contains "${DEV_UP}" 'upsert_env_file "\$\{ENV_FILE\}" "CORS_ORIGINS" "http://localhost:\$\{web_port\},http://127\.0\.0\.1:\$\{web_port\},http://join\.localhost:\$\{web_port\},http://localhost:\$\{admin_port\},http://127\.0\.0\.1:\$\{admin_port\}"'
