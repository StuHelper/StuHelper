...
assert_env_value "${env_file}" "APP_RUNTIME_MODE" "app"
assert_env_value "${env_file}" "CAMPUS_CONNECTOR_GATEWAY_PUBLIC_PORT" "9444"
assert_env_value "${env_file}" "CAMPUS_CONNECTOR_ALLOWED_SOURCE_CIDRS" ""
assert_env_value "${env_file}" "CORS_ORIGINS" "http://localhost:3000,http://127.0.0.1:3000,http://join.localhost:3000,http://localhost:3001,http://127.0.0.1:3001"
assert_env_value "${env_file}" "CASDOOR_ADDITIONAL_REDIRECT_URIS" "http://localhost:3000/api/v1/auth/callback,http://127.0.0.1:3000/api/v1/auth/callback,http://join.localhost:3000/api/v1/auth/callback"
assert_env_value "${env_file}" "CASDOOR_ADMIN_ADDITIONAL_REDIRECT_URIS" "http://localhost:3001/api/v1/auth/callback,http://127.0.0.1:3001/api/v1/auth/callback"
assert_env_value "${env_file}" "ADMISSION_PUBLIC_BASE_URL" "http://join.localhost:3000"
...
assert_env_value "${env_file}" "EMAIL_ENABLED" "true"
assert_env_value "${env_file}" "EMAIL_DRIVER" "smtp"
assert_env_value "${env_file}" "EMAIL_STUDENT_VERIFICATION_SUBJECT" "学生认证验证码"
assert_env_value "${env_file}" "EMAIL_SMTP_HOST" "localhost"
assert_env_value "${env_file}" "EMAIL_SMTP_PORT" "1025"
assert_env_value "${env_file}" "EMAIL_FROM" "no-reply@stuhelper.local"
assert_env_value "${env_file}" "EMAIL_FROM_NAME" "StuHelper 系统邮件"
assert_env_value "${env_file}" "EMAIL_SMTP_STARTTLS" "false"
...
assert_env_value "${env_file}" "WEB_VITE_QQ_BOT_ENTRY" ""
assert_env_value "${env_file}" "WEB_VITE_QQ_BIND_COMMAND" "绑定"
assert_env_value "${env_file}" "FRONTEND_METRICS_ALLOWED_ORIGINS" ""
...
assert_env_value "${legacy_env}" "CAMPUS_CONNECTOR_ALLOWED_SOURCE_CIDRS" ""
...
assert_env_value "${legacy_env}" "EMAIL_ENABLED" "true"
assert_env_value "${legacy_env}" "EMAIL_DRIVER" "smtp"
assert_env_value "${legacy_env}" "EMAIL_STUDENT_VERIFICATION_SUBJECT" "学生认证验证码"
assert_env_value "${legacy_env}" "EMAIL_SMTP_HOST" "localhost"
assert_env_value "${legacy_env}" "EMAIL_SMTP_PORT" "1025"
assert_env_value "${legacy_env}" "EMAIL_FROM" "no-reply@stuhelper.local"
assert_env_value "${legacy_env}" "EMAIL_FROM_NAME" "StuHelper 系统邮件"
assert_env_value "${legacy_env}" "EMAIL_SMTP_STARTTLS" "false"
...
assert_env_value "${legacy_env}" "FRONTEND_METRICS_ALLOWED_ORIGINS" ""
...
assert_env_value "${polluted_env}" "APP_RUNTIME_MODE" "app"
...
assert_env_value "${polluted_env}" "CASDOOR_ADDITIONAL_REDIRECT_URIS" "http://localhost:3000/api/v1/auth/callback,http://127.0.0.1:3000/api/v1/auth/callback,http://join.localhost:3000/api/v1/auth/callback"
...
assert_env_value "${polluted_env}" "CASDOOR_ADMIN_ADDITIONAL_REDIRECT_URIS" "http://localhost:3001/api/v1/auth/callback,http://127.0.0.1:3001/api/v1/auth/callback"
...
assert_env_value "${polluted_env}" "ADMISSION_PUBLIC_BASE_URL" "http://join.localhost:3000"
...
assert_env_value "${polluted_env}" "WEB_VITE_QQ_BOT_ENTRY" ""
assert_env_value "${polluted_env}" "WEB_VITE_QQ_BIND_COMMAND" "绑定"
