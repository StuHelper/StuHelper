...
assert_env_value "${env_file}" "WEB_VITE_QQ_BOT_ENTRY" "StuHelper QQ Bot"
...
assert_env_value "${legacy_env}" "WEB_VITE_QQ_BOT_ENTRY" "StuHelper QQ Bot"
...
assert_env_value "${polluted_env}" "WEB_VITE_QQ_BOT_ENTRY" "StuHelper QQ Bot"
