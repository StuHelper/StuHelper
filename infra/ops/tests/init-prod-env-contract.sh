...
assert_env_value "${fresh_env}" "ADMISSION_PUBLIC_SMOKE_DISABLED_ID_URL" "https://id.stuhelper.com"
...
assert_env_value "${fresh_env}" "PUBLIC_WEB_AUTH_BROWSER_SMOKE_DISABLED_ID_URL" "https://id.stuhelper.com"
...
assert_env_value "${fresh_env}" "IDENTITY_SERVER_ENABLED" "false"
assert_env_value "${fresh_env}" "IDENTITY_ISSUER" ""
...
assert_env_value "${fresh_env}" "IDENTITY_PUBLIC_SMOKE_ENABLED" "false"
...
assert_env_value "${legacy_env}" "IDENTITY_SERVER_ENABLED" "false"
assert_env_value "${legacy_env}" "IDENTITY_ISSUER" ""
...
assert_env_value "${legacy_env}" "IDENTITY_PUBLIC_SMOKE_ENABLED" "false"
...
assert_env_value "${legacy_env}" "ADMISSION_PUBLIC_SMOKE_DISABLED_ID_URL" "https://id.stuhelper.com"
...
assert_env_value "${legacy_env}" "PUBLIC_WEB_AUTH_BROWSER_SMOKE_DISABLED_ID_URL" "https://id.stuhelper.com"
