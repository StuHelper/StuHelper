...
assert_env_value "${fresh_env}" "STUDENT_VERIFICATION_PRODUCTION_READINESS_ENABLED" "true"
assert_env_value "${fresh_env}" "STUDENT_VERIFICATION_READINESS_REQUIRED_SCHOOL_CODES" "4111010006"
assert_env_value "${fresh_env}" "STUDENT_VERIFICATION_READINESS_REQUIRED_METHODS" "real_name_identity_check,school_sso,manual_material_review"
assert_env_value "${fresh_env}" "STUDENT_VERIFICATION_READINESS_EXPECTED_SYNC_SECONDS" "604800"
assert_env_value "${fresh_env}" "STUDENT_VERIFICATION_READINESS_EXPECTED_WARNING_SECONDS" "691200"
assert_env_value "${fresh_env}" "STUDENT_VERIFICATION_READINESS_EXPECTED_HARD_EXPIRY_SECONDS" "1209600"
assert_env_value "${fresh_env}" "STUDENT_VERIFICATION_READINESS_EVIDENCE_FILE" "infra/generated/student-verification-production-readiness.json"
...
assert_env_value "${fresh_env}" "POSTGRES_ARCHIVE_MODE" "on"
assert_env_value "${fresh_env}" "POSTGRES_ARCHIVE_TIMEOUT" "15min"
assert_env_value "${fresh_env}" "EXTERNAL_POSTGRES_PITR_EVIDENCE_FILE" "/etc/stuhelper/external-postgres-pitr-evidence.json"
...
assert_env_value "${fresh_env}" "EXTERNAL_STUDENT_SOURCE_ORACLE_READONLY_USERNAME" "REPLACE_WITH_EXISTING_EXTERNAL_STUDENT_SOURCE_ORACLE_USERNAME"
...
assert_env_value "${fresh_env}" "ADMISSION_MVP_PRODUCTION_RUN_EXTERNAL_STUDENT_SOURCE_SMOKE" "auto"
...
assert_env_value "${fresh_secrets}" "EXTERNAL_STUDENT_SOURCE_ORACLE_USERNAME" "REPLACE_WITH_EXISTING_EXTERNAL_STUDENT_SOURCE_ORACLE_USERNAME"
...
assert_env_value "${fresh_env}" "OPEN_PLATFORM_CONSENT_BASE_URL" "https://stuhelper.com"
assert_env_value "${fresh_env}" "OPEN_PLATFORM_ACCOUNT_BASE_URL" "https://stuhelper.com"
...
assert_env_value "${fresh_env}" "CAMPUS_CONNECTOR_GATEWAY_PUBLIC_PORT" "9444"
assert_env_value "${fresh_env}" "CAMPUS_CONNECTOR_ALLOWED_SOURCE_CIDRS" "REPLACE_WITH_APPROVED_CAMPUS_CONNECTOR_SOURCE_CIDRS"
...
assert_env_value "${fresh_env}" "PUBLIC_INGRESS_PUBLIC_DNS_RESOLVERS" "https://doh.pub/dns-query,https://dns.alidns.com/resolve,https://dns.google/resolve"
...
assert_env_value "${fresh_env}" "WEB_VITE_QQ_BOT_ENTRY" ""
assert_env_value "${fresh_env}" "WEB_VITE_QQ_BIND_COMMAND" "绑定"
...
assert_env_value "${fresh_env}" "BACKUP_OBJECT_STORAGE_LOCAL_IDENTITY_CIDRS" ""
assert_env_value "${fresh_env}" "BACKUP_OBJECT_STORAGE_PROVIDER" "Other"
assert_env_value "${fresh_env}" "BACKUP_OBJECT_STORAGE_PROVIDER_PRIVATE_ENDPOINT" "none"
...
assert_env_value "${fresh_env}" "ALERTMANAGER_CONFIG_GID" "65534"
assert_env_value "${fresh_env}" "ALLOW_LOCAL_ALERT_SINK" "false"
assert_file_contains "${fresh_secrets}" '^ALERTMANAGER_WEBHOOK_TOKEN=[0-9a-f]{64}$'
...
sed -i -E '/^STUDENT_VERIFICATION_(PRODUCTION_READINESS_ENABLED|READINESS_(REQUIRED_SCHOOL_CODES|REQUIRED_METHODS|EXPECTED_SYNC_SECONDS|EXPECTED_WARNING_SECONDS|EXPECTED_HARD_EXPIRY_SECONDS|EVIDENCE_FILE))=/d' "${legacy_dir}/.env.prod.shared"
...
assert_env_value "${legacy_env}" "POSTGRES_ARCHIVE_MODE" "on"
assert_env_value "${legacy_env}" "POSTGRES_ARCHIVE_TIMEOUT" "15min"
assert_env_value "${legacy_env}" "EXTERNAL_POSTGRES_PITR_EVIDENCE_FILE" "/etc/stuhelper/external-postgres-pitr-evidence.json"
...
assert_env_value "${legacy_env}" "STUDENT_VERIFICATION_PRODUCTION_READINESS_ENABLED" "true"
assert_env_value "${legacy_env}" "STUDENT_VERIFICATION_READINESS_REQUIRED_SCHOOL_CODES" "4111010006"
assert_env_value "${legacy_env}" "STUDENT_VERIFICATION_READINESS_REQUIRED_METHODS" "real_name_identity_check,school_sso,manual_material_review"
assert_env_value "${legacy_env}" "STUDENT_VERIFICATION_READINESS_EXPECTED_SYNC_SECONDS" "604800"
assert_env_value "${legacy_env}" "STUDENT_VERIFICATION_READINESS_EXPECTED_WARNING_SECONDS" "691200"
assert_env_value "${legacy_env}" "STUDENT_VERIFICATION_READINESS_EXPECTED_HARD_EXPIRY_SECONDS" "1209600"
assert_env_value "${legacy_env}" "STUDENT_VERIFICATION_READINESS_EVIDENCE_FILE" "infra/generated/student-verification-production-readiness.json"
...
assert_env_value "${legacy_env}" "OPEN_PLATFORM_CONSENT_BASE_URL" "https://stuhelper.com"
assert_env_value "${legacy_env}" "OPEN_PLATFORM_ACCOUNT_BASE_URL" "https://stuhelper.com"
...
assert_env_value "${legacy_env}" "CAMPUS_CONNECTOR_GATEWAY_PUBLIC_PORT" "9444"
assert_env_value "${legacy_env}" "CAMPUS_CONNECTOR_ALLOWED_SOURCE_CIDRS" "REPLACE_WITH_APPROVED_CAMPUS_CONNECTOR_SOURCE_CIDRS"
...
assert_env_value "${legacy_env}" "PUBLIC_INGRESS_PUBLIC_DNS_RESOLVERS" "https://doh.pub/dns-query,https://dns.alidns.com/resolve,https://dns.google/resolve"
...
assert_env_value "${legacy_env}" "WEB_VITE_QQ_BOT_ENTRY" ""
assert_env_value "${legacy_env}" "WEB_VITE_QQ_BIND_COMMAND" "绑定"
...
assert_env_value "${legacy_env}" "ALERTMANAGER_CONFIG_GID" "65534"
assert_env_value "${legacy_env}" "ALLOW_LOCAL_ALERT_SINK" "false"
assert_file_contains "${legacy_dir}/.env.prod.secrets.local" '^ALERTMANAGER_WEBHOOK_TOKEN=[0-9a-f]{64}$'
