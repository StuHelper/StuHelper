...
assert_env_value "${fresh_env}" "CASDOOR_PUBLIC_AUTH_BASE_URL" "https://id.stuhelper.com"
assert_env_value "${fresh_env}" "CASDOOR_REDIRECT_URI" "https://id.stuhelper.com/api/v1/auth/callback"
...
assert_env_value "${fresh_env}" "CASDOOR_ADMIN_REDIRECT_URI" "https://id.stuhelper.com/api/v1/auth/callback"
assert_env_value "${fresh_env}" "CASDOOR_UNIAPP_CLIENT_ID" "stuhelper-uniapp"
assert_env_value "${fresh_env}" "CASDOOR_UNIAPP_REDIRECT_URI" "https://id.stuhelper.com/api/v1/auth/callback"
...
assert_env_value "${fresh_env}" "PUBLIC_INGRESS_CASDOOR_UPSTREAM_PREFLIGHT_ENABLED" "false"
assert_env_value "${fresh_env}" "PUBLIC_INGRESS_PREFLIGHT_TIMEOUT_SECONDS" "10"
assert_env_value "${fresh_env}" "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_TIMEOUT" "10"
assert_env_value "${fresh_env}" "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_FILE" "infra/generated/public-identity-ingress-diagnostic.json"
assert_env_value "${fresh_env}" "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_STRICT" "false"
assert_env_value "${fresh_env}" "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_PUBLIC_DNS_ENABLED" "true"
assert_env_value "${fresh_env}" "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_USE_ENV_TARGETS" "false"
assert_env_value "${fresh_env}" "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_CASDOOR_UPSTREAM_ENABLED" "false"
assert_env_value "${fresh_env}" "IDENTITY_PUBLIC_SMOKE_ENABLED" "true"
assert_env_value "${fresh_env}" "IDENTITY_PUBLIC_SMOKE_BOOTSTRAP_ENABLED" "false"
assert_env_value "${fresh_env}" "IDENTITY_PUBLIC_SMOKE_BOOTSTRAP_MODE" "container"
assert_env_value "${fresh_env}" "IDENTITY_PUBLIC_SMOKE_OWNER_USER_ID" ""
assert_env_value "${fresh_env}" "IDENTITY_PUBLIC_SMOKE_REVIEWER_USER_ID" ""
assert_env_value "${fresh_env}" "IDENTITY_PUBLIC_SMOKE_HOMEPAGE_URL" "https://stuhelper.com"
assert_env_value "${fresh_env}" "IDENTITY_PUBLIC_SMOKE_PRIVACY_POLICY_URL" "https://stuhelper.com/privacy"
assert_env_value "${fresh_env}" "IDENTITY_PUBLIC_SMOKE_ALLOW_LOCAL_TARGETS" "false"
assert_env_value "${fresh_env}" "IDENTITY_PUBLIC_SMOKE_CASDOOR_UPSTREAM_ENABLED" "false"
assert_env_value "${fresh_env}" "WEB_VITE_API_URL" "/api"
assert_env_value "${fresh_env}" "WEB_VITE_SSO_URL" "https://id.stuhelper.com"
assert_env_value "${fresh_env}" "WEB_VITE_IDENTITY_URL" "https://id.stuhelper.com"
...
assert_env_value "${legacy_env}" "CASDOOR_PUBLIC_AUTH_BASE_URL" "https://id.stuhelper.com"
assert_env_value "${legacy_env}" "CASDOOR_REDIRECT_URI" "https://id.stuhelper.com/api/v1/auth/callback"
...
assert_env_value "${legacy_env}" "CASDOOR_ADMIN_REDIRECT_URI" "https://id.stuhelper.com/api/v1/auth/callback"
assert_env_value "${legacy_env}" "CASDOOR_UNIAPP_CLIENT_ID" "stuhelper-uniapp"
assert_env_value "${legacy_env}" "CASDOOR_UNIAPP_REDIRECT_URI" "https://id.stuhelper.com/api/v1/auth/callback"
...
assert_env_value "${legacy_env}" "PUBLIC_INGRESS_CASDOOR_UPSTREAM_PREFLIGHT_ENABLED" "false"
assert_env_value "${legacy_env}" "PUBLIC_INGRESS_PREFLIGHT_TIMEOUT_SECONDS" "10"
assert_env_value "${legacy_env}" "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_TIMEOUT" "10"
assert_env_value "${legacy_env}" "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_FILE" "infra/generated/public-identity-ingress-diagnostic.json"
assert_env_value "${legacy_env}" "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_STRICT" "false"
assert_env_value "${legacy_env}" "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_PUBLIC_DNS_ENABLED" "true"
assert_env_value "${legacy_env}" "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_USE_ENV_TARGETS" "false"
assert_env_value "${legacy_env}" "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_CASDOOR_UPSTREAM_ENABLED" "false"
assert_env_value "${legacy_env}" "IDENTITY_PUBLIC_SMOKE_ENABLED" "true"
assert_env_value "${legacy_env}" "IDENTITY_PUBLIC_SMOKE_BOOTSTRAP_ENABLED" "false"
assert_env_value "${legacy_env}" "IDENTITY_PUBLIC_SMOKE_BOOTSTRAP_MODE" "container"
assert_env_value "${legacy_env}" "IDENTITY_PUBLIC_SMOKE_OWNER_USER_ID" ""
assert_env_value "${legacy_env}" "IDENTITY_PUBLIC_SMOKE_REVIEWER_USER_ID" ""
assert_env_value "${legacy_env}" "IDENTITY_PUBLIC_SMOKE_HOMEPAGE_URL" "https://stuhelper.com"
assert_env_value "${legacy_env}" "IDENTITY_PUBLIC_SMOKE_PRIVACY_POLICY_URL" "https://stuhelper.com/privacy"
assert_env_value "${legacy_env}" "IDENTITY_PUBLIC_SMOKE_ALLOW_LOCAL_TARGETS" "false"
assert_env_value "${legacy_env}" "IDENTITY_PUBLIC_SMOKE_CASDOOR_UPSTREAM_ENABLED" "false"
assert_env_value "${legacy_env}" "WEB_VITE_API_URL" "/api"
assert_env_value "${legacy_env}" "WEB_VITE_SSO_URL" "https://id.stuhelper.com"
assert_env_value "${legacy_env}" "WEB_VITE_IDENTITY_URL" "https://id.stuhelper.com"
