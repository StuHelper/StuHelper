...
JSON
  ...
  stale-released)
    cat <<'JSON'
{"input":{"platform":"qq","guildID":"178037297","qqID":"123456789","botSelfID":"2118785781","lookbackHours":24},"sessionCount":1,"latestSession":{"id":"sess-stale","platform":"qq","botSelfID":"2118785781","guildID":"178037297","channelIDPresent":true,"qqID":"123456789","userIDPresent":true,"authURLHost":"join.stuhelper.com","authURLPath":"/verify/redacted","authURLHasQQQuery":false,"authURLCanonicalPrefix":true,"tokenHashPresent":true,"tokenConsumed":true,"status":"verified","verified":true,"cancelledAtPresent":true,"botReleaseRecorded":true,"lastBotErrorPresent":false,"createdAt":"2026-05-30T12:00:00Z","updatedAt":"2026-05-30T12:10:00Z","sessionAgeSeconds":90000,"updatedAgeSeconds":89000,"tokenExpiresAt":"2026-05-30T13:00:00Z","tokenExpired":true,"linkWaitDeadlineAt":"2026-05-30T13:00:00Z","submissionWaitDeadlineAt":"2026-05-31T12:00:00Z","initialMuteUntil":"2026-06-29T12:00:00Z"},"user":{"idPresent":true,"casdoorSubjectPresent":true,"usernamePresent":true,"emailPresent":true},"qqBinding":{"bound":true,"boundAt":"2026-05-30T12:05:00Z"},"studentVerification":{"activeCredentialCount":1,"kinds":["school_email_otp"],"schoolIDs":[4111010006]},"freshmanApplications":{"count":0,"statuses":[]},"failure":{"failureCount":0,"lastFailureAt":null},"activeBlacklistCount":0}
JSON
    ;;
  released-no-credential)
    cat <<'JSON'
{"input":{"platform":"qq","guildID":"178037297","qqID":"123456789","botSelfID":"2118785781","lookbackHours":24},"sessionCount":1,"latestSession":{"id":"sess-no-credential","platform":"qq","botSelfID":"2118785781","guildID":"178037297","channelIDPresent":true,"qqID":"123456789","userIDPresent":true,"authURLHost":"join.stuhelper.com","authURLPath":"/verify/redacted","authURLHasQQQuery":false,"authURLCanonicalPrefix":true,"tokenHashPresent":true,"tokenConsumed":true,"status":"verified","verified":true,"cancelledAtPresent":true,"botReleaseRecorded":true,"lastBotErrorPresent":false,"createdAt":"2026-05-30T12:00:00Z","updatedAt":"2026-05-30T12:10:00Z","sessionAgeSeconds":600,"updatedAgeSeconds":60,"tokenExpiresAt":"2026-05-30T13:00:00Z","tokenExpired":false,"linkWaitDeadlineAt":"2026-05-30T13:00:00Z","submissionWaitDeadlineAt":"2026-05-31T12:00:00Z","initialMuteUntil":"2026-06-29T12:00:00Z"},"user":{"idPresent":true,"casdoorSubjectPresent":true,"usernamePresent":true,"emailPresent":true},"qqBinding":{"bound":true,"boundAt":"2026-05-30T12:05:00Z"},"studentVerification":{"activeCredentialCount":0,"kinds":[],"schoolIDs":[]},"freshmanApplications":{"count":1,"statuses":["pending"]},"failure":{"failureCount":0,"lastFailureAt":null},"activeBlacklistCount":0}
JSON
    ;;
  linked-freshman-created)
    cat <<'JSON'
{"input":{"platform":"qq","guildID":"178037297","qqID":"123456789","botSelfID":"2118785781","lookbackHours":24},"sessionCount":1,"latestSession":{"id":"sess-linked-freshman-created","platform":"qq","botSelfID":"2118785781","guildID":"178037297","channelIDPresent":true,"qqID":"123456789","userIDPresent":true,"authURLHost":"join.stuhelper.com","authURLPath":"/verify/redacted","authURLHasQQQuery":false,"authURLCanonicalPrefix":true,"tokenHashPresent":true,"tokenConsumed":true,"status":"linked","verified":false,"cancelledAtPresent":false,"botReleaseRecorded":false,"lastBotErrorPresent":false,"createdAt":"2026-05-30T12:00:00Z","updatedAt":"2026-05-30T12:05:00Z","sessionAgeSeconds":600,"updatedAgeSeconds":300,"tokenExpiresAt":"2026-05-30T13:00:00Z","tokenExpired":false,"linkWaitDeadlineAt":"2026-05-30T13:00:00Z","submissionWaitDeadlineAt":"2026-05-31T12:00:00Z","initialMuteUntil":"2026-06-29T12:00:00Z"},"user":{"idPresent":true,"casdoorSubjectPresent":true,"usernamePresent":true,"emailPresent":true},"qqBinding":{"bound":true,"boundAt":"2026-05-30T12:05:00Z"},"studentVerification":{"activeCredentialCount":0,"kinds":[],"schoolIDs":[]},"freshmanApplications":{"count":1,"statuses":["pending"]},"failure":{"failureCount":0,"lastFailureAt":null},"activeBlacklistCount":0}
JSON
    ;;
  none)
    cat <<'JSON'
