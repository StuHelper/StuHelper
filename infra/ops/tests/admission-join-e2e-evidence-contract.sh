...
case "${FAKE_E2E_MODE:-completed}" in
  completed)
    cat <<'JSON'
{"input":{"platform":"qq","guildID":"178037297","qqID":"123456789","botSelfID":"2118785781","lookbackHours":24},"sessionCount":1,"latestSession":{"id":"sess-1","platform":"qq","botSelfID":"2118785781","guildID":"178037297","channelIDPresent":true,"qqID":"123456789","userIDPresent":true,"authURLHost":"join.stuhelper.com","authURLPath":"/verify/redacted","authURLHasQQQuery":true,"authURLCanonicalPrefix":true,"tokenHashPresent":true,"tokenConsumed":true,"status":"verified","verified":true,"cancelledAtPresent":true,"botReleaseRecorded":true,"lastBotErrorPresent":false,"createdAt":"2026-05-30T12:00:00Z","updatedAt":"2026-05-30T12:10:00Z","sessionAgeSeconds":600,"updatedAgeSeconds":60,"tokenExpiresAt":"2026-05-30T13:00:00Z","tokenExpired":false,"linkWaitDeadlineAt":"2026-05-30T13:00:00Z","submissionWaitDeadlineAt":"2026-05-31T12:00:00Z","initialMuteUntil":"2026-06-29T12:00:00Z"},"user":{"idPresent":true,"casdoorSubjectPresent":true,"usernamePresent":true,"emailPresent":true},"qqBinding":{"bound":true,"boundAt":"2026-05-30T12:05:00Z"},"studentVerification":{"activeCredentialCount":1,"kinds":["school_email_otp"],"schoolIDs":[10006]},"freshmanApplications":{"count":0,"statuses":[]},"failure":{"failureCount":0,"lastFailureAt":null},"activeBlacklistCount":0}
JSON
    ;;
  joined)
    cat <<'JSON'
