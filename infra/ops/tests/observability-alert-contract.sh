...
assert_contains "StuHelperInvalidOpenFGARoleScope"
assert_contains "increase(iam_invalid_role_scope_total[10m]) > 0"
assert_contains "Invalid OpenFGA role scope needs reconciliation"
