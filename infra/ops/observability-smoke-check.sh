...
PROM_READY_URL="${PROMETHEUS_URL:-http://127.0.0.1:9090/-/ready}"
GRAFANA_HEALTH_URL="${GRAFANA_URL:-http://127.0.0.1:3003/api/health}"
LOKI_READY_URL="${LOKI_URL:-http://127.0.0.1:3100/ready}"
TEMPO_READY_URL="${TEMPO_URL:-http://127.0.0.1:3200/ready}"
ALERT_READY_URL="${ALERTMANAGER_URL:-http://127.0.0.1:9093/-/ready}"
ALLOY_READY_URL="${ALLOY_URL:-http://127.0.0.1:12345/-/ready}"
