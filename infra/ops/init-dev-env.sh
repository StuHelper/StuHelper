...
ensure_dev_default \
  ...
  "http://stuhelper.com,http://id.stuhelper.com"
...
replace_legacy_env_value "IDENTITY_SERVER_ENABLED" "${IDENTITY_SERVER_ENABLED:-}" "false" "true"
replace_legacy_env_value "IDENTITY_ISSUER" "${IDENTITY_ISSUER:-}" "" "http://localhost:3000" "http://127.0.0.1:28000" "http://id.stuhelper.com" "https://id.stuhelper.com"
...
replace_legacy_env_value "IDENTITY_PUBLIC_SMOKE_CASDOOR_UPSTREAM_ENABLED" "${IDENTITY_PUBLIC_SMOKE_CASDOOR_UPSTREAM_ENABLED:-}" "false" "true"
replace_legacy_env_value "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_CASDOOR_UPSTREAM_ENABLED" "${PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_CASDOOR_UPSTREAM_ENABLED:-}" "false" "true"
...
replace_legacy_env_value "IDENTITY_PUBLIC_SMOKE_HOMEPAGE_URL" "${IDENTITY_PUBLIC_SMOKE_HOMEPAGE_URL:-}" "http://localhost:3000" "http://127.0.0.1:28000" "http://stuhelper.com" "https://stuhelper.com"
replace_legacy_env_value "IDENTITY_PUBLIC_SMOKE_PRIVACY_POLICY_URL" "${IDENTITY_PUBLIC_SMOKE_PRIVACY_POLICY_URL:-}" "http://localhost:3000/privacy" "http://127.0.0.1:28000/privacy" "http://stuhelper.com/privacy" "https://stuhelper.com/privacy"
...
ensure_dev_default "CASDOOR_PUBLIC_AUTH_BASE_URL" "${CASDOOR_PUBLIC_AUTH_BASE_URL:-}" "" "http://sso.stuhelper.com" "https://sso.stuhelper.com" "http://id.stuhelper.com" "https://id.stuhelper.com"
ensure_dev_default "CASDOOR_REDIRECT_URI" "${CASDOOR_REDIRECT_URI:-}" "http://localhost:8080/api/v1/auth/callback" "http://127.0.0.1:28080/api/v1/auth/callback" "http://stuhelper.com/api/v1/auth/callback" "https://stuhelper.com/api/v1/auth/callback" "http://id.stuhelper.com/api/v1/auth/callback" "https://id.stuhelper.com/api/v1/auth/callback"
...
ensure_dev_default "CASDOOR_ADMIN_REDIRECT_URI" "${CASDOOR_ADMIN_REDIRECT_URI:-}" "http://localhost:8080/api/v1/auth/callback" "http://127.0.0.1:28080/api/v1/auth/callback" "http://stuhelper.com/api/v1/auth/callback" "https://stuhelper.com/api/v1/auth/callback" "http://id.stuhelper.com/api/v1/auth/callback" "https://id.stuhelper.com/api/v1/auth/callback"
ensure_dev_default "CASDOOR_UNIAPP_REDIRECT_URI" "${CASDOOR_UNIAPP_REDIRECT_URI:-}" "http://localhost:8080/api/v1/auth/callback" "http://127.0.0.1:28080/api/v1/auth/callback" "http://stuhelper.com/api/v1/auth/callback" "https://stuhelper.com/api/v1/auth/callback" "http://id.stuhelper.com/api/v1/auth/callback" "https://id.stuhelper.com/api/v1/auth/callback"
...
ensure_dev_default "EMAIL_ENABLED" "${EMAIL_ENABLED:-}" "false" "true"
...
ensure_dev_default "EMAIL_SMTP_HOST" "${EMAIL_SMTP_HOST:-}" "" "mailhog" "REPLACE_WITH_EMAIL_SMTP_HOST"
...
ensure_value "EMAIL_FROM" "${EMAIL_FROM:-}" ""
...
ensure_dev_default "WEB_VITE_SSO_URL" "${WEB_VITE_SSO_URL:-}" "http://localhost:8085" "http://host.docker.internal:8085" "http://sso.stuhelper.com" "https://sso.stuhelper.com" "http://id.stuhelper.com" "https://id.stuhelper.com" "http://127.0.0.1:28085"
ensure_dev_default "WEB_VITE_IDENTITY_URL" "${WEB_VITE_IDENTITY_URL:-}" "" "http://id.stuhelper.com" "https://id.stuhelper.com"
...
ensure_dev_default "IDENTITY_PUBLIC_SMOKE_CASDOOR_UPSTREAM_ENABLED" "${IDENTITY_PUBLIC_SMOKE_CASDOOR_UPSTREAM_ENABLED:-}" "false" "true"
ensure_dev_default "PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_CASDOOR_UPSTREAM_ENABLED" "${PUBLIC_IDENTITY_INGRESS_DIAGNOSTIC_CASDOOR_UPSTREAM_ENABLED:-}" "false" "true"
