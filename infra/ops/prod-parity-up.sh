...
ensure_file_value "${ENV_FILE}" "IDENTITY_ISSUER" "https://id.stuhelper.com"
ensure_file_value "${ENV_FILE}" "WEB_VITE_API_URL" "/api"
ensure_file_value "${ENV_FILE}" "WEB_VITE_SSO_URL" "https://id.stuhelper.com"
ensure_file_value "${ENV_FILE}" "WEB_VITE_IDENTITY_URL" "https://id.stuhelper.com"
...
ensure_file_value "${ENV_FILE}" "CASDOOR_PUBLIC_AUTH_BASE_URL" "https://id.stuhelper.com"
ensure_file_value "${ENV_FILE}" "CASDOOR_INTERNAL_ADDRESS" "host.docker.internal:80"
ensure_file_value "${ENV_FILE}" "CASDOOR_REDIRECT_URI" "https://id.stuhelper.com/api/v1/auth/callback"
...
ensure_file_value "${ENV_FILE}" "CASDOOR_ADMIN_REDIRECT_URI" "https://id.stuhelper.com/api/v1/auth/callback"
ensure_file_value "${ENV_FILE}" "CASDOOR_UNIAPP_CLIENT_ID" "stuhelper-uniapp"
ensure_file_value "${ENV_FILE}" "CASDOOR_UNIAPP_REDIRECT_URI" "https://id.stuhelper.com/api/v1/auth/callback"
...
ensure_file_value "${ENV_FILE}" "CORS_ORIGINS" "https://stuhelper.com,https://id.stuhelper.com"
