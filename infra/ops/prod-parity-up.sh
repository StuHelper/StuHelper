...
ensure_file_value "${ENV_FILE}" "WEB_VITE_SSO_URL" "http://sso.stuhelper.com"
...
ensure_file_value "${ENV_FILE}" "CASDOOR_REDIRECT_URI" "http://stuhelper.com/api/v1/auth/callback"
...
ensure_file_value "${ENV_FILE}" "CASDOOR_ADMIN_REDIRECT_URI" "http://stuhelper.com/api/v1/auth/callback"
ensure_file_value "${ENV_FILE}" "CASDOOR_UNIAPP_CLIENT_ID" "stuhelper-uniapp"
ensure_file_value "${ENV_FILE}" "CASDOOR_UNIAPP_REDIRECT_URI" "http://stuhelper.com/api/v1/auth/callback"
...
echo "  SSO:      http://sso.stuhelper.com"
