...
- `help`, `dice`, `banme`, `config`, `status`, `event`, `antirepeat`, and `manage-message` have
  been migrated to native `RuntimeModule` implementations in P4b-1 through P4b-8; the remaining
  rows still use `BaseModuleAdapter`.
