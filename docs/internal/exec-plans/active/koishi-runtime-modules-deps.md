...
- `help`, `dice`, `banme`, `config`, `status`, `event`, and `antirepeat` have been migrated
  to native `RuntimeModule` implementations in P4b-1 through P4b-7; the remaining rows still use
  `BaseModuleAdapter`.
