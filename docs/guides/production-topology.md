...
[Baota Nginx :443/:80]  ← 宿主机，负责 TLS 终止与路由
    ...
    ├── stuhelper.com /identity /login /auth/callback /consent /complete-profile /developers/* /user/authorized-apps /user/*-verification /user/*-binding /user/academic-info
    ...
    ├── id.stuhelper.com /identity /login /auth/callback /consent /complete-profile /developers/* /user/authorized-apps /user/*-verification /user/*-binding /user/academic-info /assets/*
    │       → web 前端
