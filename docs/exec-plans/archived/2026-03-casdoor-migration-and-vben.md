...
> 备注：本计划的主干事项已在代码中完成；剩余事项已转入 `/Users/zxy/Code/StuHelper/docs/exec-plans/active/iam-architecture-migration.md` 和 `/Users/zxy/Code/StuHelper/docs/exec-plans/tech-debt-tracker.md` 跟踪。
