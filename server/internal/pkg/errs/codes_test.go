...
func allErrorCodes() map[string]ErrorCode {
	return map[string]ErrorCode{
		...
		"ErrStudentVerificationSchoolNotFound":          ErrStudentVerificationSchoolNotFound,
		"ErrStudentVerificationSchoolUnavailable":       ErrStudentVerificationSchoolUnavailable,
		"ErrStudentVerificationMethodUnavailable":       ErrStudentVerificationMethodUnavailable,
		"ErrStudentVerificationApplicationMissing":      ErrStudentVerificationApplicationMissing,
		"ErrStudentVerificationApplicationExpired":      ErrStudentVerificationApplicationExpired,
		"ErrStudentVerificationStateConflict":           ErrStudentVerificationStateConflict,
		"ErrStudentVerificationConsentRequired":         ErrStudentVerificationConsentRequired,
		"ErrStudentVerificationCannotComplete":          ErrStudentVerificationCannotComplete,
		"ErrStudentVerificationCredentialMissing":       ErrStudentVerificationCredentialMissing,
		"ErrStudentVerificationCredentialConflict":      ErrStudentVerificationCredentialConflict,
		"ErrStudentVerificationContinuationInvalid":     ErrStudentVerificationContinuationInvalid,
		"ErrStudentVerificationOTPCooldown":             ErrStudentVerificationOTPCooldown,
		"ErrStudentVerificationOTPExpired":              ErrStudentVerificationOTPExpired,
		"ErrStudentVerificationOTPInvalid":              ErrStudentVerificationOTPInvalid,
		"ErrStudentVerificationOTPMaxAttempts":          ErrStudentVerificationOTPMaxAttempts,
		"ErrStudentVerificationInboundChallengeMissing": ErrStudentVerificationInboundChallengeMissing,
		"ErrAccountPhoneInvalid":                        ErrAccountPhoneInvalid,
		"ErrAccountPhoneOperationMissing":               ErrAccountPhoneOperationMissing,
		"ErrAccountPhoneOperationConflict":              ErrAccountPhoneOperationConflict,
		"ErrAccountPhoneBindingConflict":                ErrAccountPhoneBindingConflict,
		"ErrAccountPhoneAlreadyBound":                   ErrAccountPhoneAlreadyBound,
		"ErrAccountPhoneNotBound":                       ErrAccountPhoneNotBound,
		"ErrAccountPhoneOTPCooldown":                    ErrAccountPhoneOTPCooldown,
		"ErrAccountPhoneOTPExpired":                     ErrAccountPhoneOTPExpired,
		"ErrAccountPhoneOTPInvalid":                     ErrAccountPhoneOTPInvalid,
		"ErrAccountPhoneOTPMaxAttempts":                 ErrAccountPhoneOTPMaxAttempts,
		"ErrAccountPhoneLegacyEndpoint":                 ErrAccountPhoneLegacyEndpoint,
		"ErrStudentVerificationRosterSnapshotMissing":   ErrStudentVerificationRosterSnapshotMissing,
		"ErrStudentVerificationRosterSnapshotConflict":  ErrStudentVerificationRosterSnapshotConflict,
		"ErrStudentVerificationRosterQualityFailed":     ErrStudentVerificationRosterQualityFailed,
		"ErrStudentVerificationRosterSyncConflict":      ErrStudentVerificationRosterSyncConflict,
