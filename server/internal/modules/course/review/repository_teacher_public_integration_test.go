...
func TestTeacherPublicStats_RefreshAndList(t *testing.T) {
	...
	teacherA := seedTeacher(t, fixture, 4111010006, "王老师", departmentID)
	teacherB := seedTeacher(t, fixture, 4111010006, "李老师", departmentID)
	courseA := seedCourse(t, fixture, 4111010006, departmentID, "数据库系统")
	courseB := seedCourse(t, fixture, 4111010006, departmentID, "分布式系统")
...
func TestTeacherPublicStats_SearchAndDepartmentFilter(t *testing.T) {
	...
	deptCS := seedDepartment(t, fixture, 4111010006, "计算机学院")
	deptMath := seedDepartment(t, fixture, 4111010006, "数学学院")
	teacherCS := seedTeacher(t, fixture, 4111010006, "张三", deptCS)
	teacherMath := seedTeacher(t, fixture, 4111010006, "李四", deptMath)
	courseCS := seedCourse(t, fixture, 4111010006, deptCS, "算法设计")
	courseMath := seedCourse(t, fixture, 4111010006, deptMath, "高等数学")
