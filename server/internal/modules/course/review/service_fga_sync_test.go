...
func (f *fakeReviewFGAWriter) WriteReviewRelations(_ context.Context, reviewID, authorUserID, schoolID string) error {
	f.reviewArgs = []string{reviewID, authorUserID, schoolID}
	return f.err
}

func (f *fakeReviewFGAWriter) WriteReportRelations(_ context.Context, reportID, schoolID string) error {
	f.reportArgs = []string{reportID, schoolID}
	return f.err
}
