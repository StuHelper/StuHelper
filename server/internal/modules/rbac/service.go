...
func (s *Service) UpdateRole(ctx context.Context, id int64, displayName, description string) (*Role, error) {
	...
	role.Description = strPtr(description)
...
// UpdateGroup 更新用户组
func (s *Service) UpdateGroup(ctx context.Context, id int64, displayName, desc string) (*UserGroup, error) {
...
func (s *Service) GetGroupMembers(ctx context.Context, groupID int64) ([]int64, error) {
