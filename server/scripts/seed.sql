...
INSERT INTO departments (id, school_id, name, short_name, category, sort_order) VALUES
    (1, 10006, '计算机学院', '计算机', '工科', 1),
    (2, 10006, '数学科学学院', '数学', '理科', 2),
    (3, 10006, '外国语学院', '外语', '文科', 3),
    (4, 10006, '经济管理学院', '经管', '文科', 4),
    (5, 10006, '电子信息工程学院', '电信', '工科', 5),
    (6, 10006, '马克思主义学院', '马院', '思政', 6),
    (7, 10006, '体育部', '体育', '体育', 7),
    (8, 10006, '新媒体与艺术设计学院', '艺术', '文科', 8)
...
INSERT INTO courses (id, school_id, name, code, department_id, credits, category) VALUES
    -- 通识课
    (1, 10006, '大学计算机基础', 'CS1001', 1, 2.0, '通识'),
    (2, 10006, '信息技术导论', 'CS1002', 1, 2.0, '通识'),
    -- 计算机专业课
    (3, 10006, '数据结构与算法', 'CS2001', 1, 4.0, ''),
    (4, 10006, 'Java程序设计', 'CS2002', 1, 3.5, ''),
    (5, 10006, '操作系统原理', 'CS3001', 1, 4.0, ''),
    (6, 10006, '计算机网络', 'CS3002', 1, 3.5, ''),
    (7, 10006, '数据库系统概论', 'CS2003', 1, 3.5, ''),
    -- 数学课
    (8, 10006, '高等数学A', 'MA1001', 2, 5.0, ''),
    (9, 10006, '线性代数', 'MA1002', 2, 3.0, ''),
    (10, 10006, '概率论与数理统计', 'MA2001', 2, 3.5, ''),
    -- 英语课
    (11, 10006, '大学英语(一)', 'EN1001', 3, 3.0, '英语'),
    (12, 10006, '大学英语(二)', 'EN1002', 3, 3.0, '英语'),
    (13, 10006, '英语口语实训', 'EN2001', 3, 2.0, '英语'),
    -- 经管课
    (14, 10006, '微观经济学', 'EC2001', 4, 3.0, ''),
    (15, 10006, '管理学原理', 'EC2002', 4, 3.0, ''),
    -- 电信课
    (16, 10006, '电路分析基础', 'EE2001', 5, 3.5, ''),
    (17, 10006, '数字电子技术', 'EE2002', 5, 3.5, ''),
    -- 思政课
    (18, 10006, '毛泽东思想和中国特色社会主义理论体系概论', 'MX1001', 6, 3.0, '思政'),
    (19, 10006, '思想道德与法治', 'MX1002', 6, 2.5, '思政'),
    -- 体育课
    (20, 10006, '大学体育-篮球', 'PE1001', 7, 1.0, '体育'),
    (21, 10006, '大学体育-羽毛球', 'PE1002', 7, 1.0, '体育'),
    -- 艺术课
    (22, 10006, '设计色彩', 'AR2001', 8, 2.0, ''),
    (23, 10006, 'UI/UX设计基础', 'AR2002', 8, 2.5, '')
ON CONFLICT (id) DO NOTHING;
