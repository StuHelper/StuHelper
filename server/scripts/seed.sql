...
(
    '019462a0-0001-7000-8000-000000000001', 3, 1, '2025-2026-1',
...
(
    '019462a0-0002-7000-8000-000000000002', 3, 1, '2025-2026-1',
...
(
    '019462a0-0003-7000-8000-000000000003', 4, 2, '2025-2026-1',
...
(
    '019462a0-0004-7000-8000-000000000004', 8, 4, '2025-2026-1',
    'hash_user_a_00000000000000000000000000000001',
    '高数噩梦',
...
(
    '019462a0-0005-7000-8000-000000000005', 8, 4, '2025-2026-1',
...
(
    '019462a0-0006-7000-8000-000000000006', 11, 6, '2025-2026-1',
    'hash_user_b_00000000000000000000000000000002',
    '轻松愉快的英语课',
...
-- 毛概 (course_id=18, 林小红)
(
    '019462a0-0007-7000-8000-000000000007', 18, 12, '2025-2026-1',
    'hash_user_c_00000000000000000000000000000003',
    '比想象中有意思',
...
(
    '019462a0-0008-7000-8000-000000000008', 20, 13, '2025-2026-1',
...
(
    '019462a0-0009-7000-8000-000000000009', 5, 3, '2024-2025-2',
    'hash_user_d_00000000000000000000000000000004',
    '硬核但值得',
...
(
    '019462a0-0010-7000-8000-000000000010', 6, 15, '2025-2026-1',
    'hash_user_a_00000000000000000000000000000001',
    '年轻老师，讲得不错',
...
(
    '019462a0-0011-7000-8000-000000000011', 23, 14, '2025-2026-1',
    'hash_user_e_00000000000000000000000000000005',
    '设计入门好课',
...
(
    '019462a0-0012-7000-8000-000000000012', 7, 2, '2024-2025-2',
    'hash_user_d_00000000000000000000000000000004',
    '实用性很强',
